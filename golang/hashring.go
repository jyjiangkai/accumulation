...
// func main() {
// 	groupIPS1 := []string{"127.0.0.1", "127.0.0.2", "127.0.0.3", "127.0.0.4", "127.0.0.5", "127.0.0.6"}
// 	hashNum := len(groupIPS1)
// 	if hashNum == 0 {
// 		hashNum = 32
// 	}
// 	fmt.Println("hashNum: ", hashNum)

// 	// 一致性hash计算谁是master，用于告警使用
// 	hash := alarm.NewHashRing(hashNum)

// 	for _, IP := range groupIPS1 {
// 		hash.AddNode(IP, 1)
// 	}

// 	// check本group的master是否是本机
// 	node := hash.GetNode("master")
// }
